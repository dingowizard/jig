...
[TestClass]
public abstract class ContinuationsBase {
    ...
    //     string result2 = "";
    //     Continuation.OneArgDelegate setResult2 = (x) => {result2 = x.Print(); return null;};
    ...
    //     string result3 = "";
    //     Continuation.OneArgDelegate setResult3 = (x) => {result3 = x.Print(); return null;};
    ...
    [TestMethod]
    public void UsingSavedContinuation() {
        string actual = Interp.InterpretSequenceReadSyntax([
            "(define cont #f)",
