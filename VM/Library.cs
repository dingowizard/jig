...
public class Library : ILibrary {
    ...
    static Library() {
        ...
        [
            ...
            new (new Parameter(new Symbol("unsafe-exit"), [], 0, index++, null),
                new Location(new Primitive("unsafe-exit", Primitives.exit, 1, false))),
            ...
            new (new Parameter(new Symbol("integer?"), [], 0, index++, null),
                new Location(new Primitive("integer?", Primitives.integerP, 1, false))),
            ...
            new (new Parameter(new Symbol("mod0-unsafe"), [], 0, index++, null),
                new Location(new Primitive("mod0-unsafe", Primitives.modulo0, 2, false))),
            new (new Parameter(new Symbol("mod-unsafe"), [], 0, index++, null),
                new Location(new Primitive("mod-unsafe", Primitives.modulo, 2, false))),
            new (new Parameter(new Symbol("unchecked-bin-op--"), [], 0, index++, null),
            ...
            new (new Parameter(new Symbol("condition?"), [], 0, index++, null),
                new Location(new Primitive("condition?", Primitives.condition_p, 1, false))),
            new (new Parameter(new Symbol("message-condition?"), [], 0, index++, null),
                new Location(new Primitive("message-condition?", Primitives.messageCondition_p, 1, false))),
            new (new Parameter(new Symbol("condition-message-unsafe"), [], 0, index++, null),
                new Location(new Primitive("condition-message-unsafe", Primitives.conditionMessage, 1, false))),
            new (new Parameter(new Symbol("condition-unsafe"), [], 0, index++, null),
                new Location(new Primitive("condition-unsafe", Primitives.condition, 0, true))),
            new (new Parameter(new Symbol("make-message-condition-unsafe"), [], 0, index++, null),
                new Location(new Primitive("make-message-condition-unsafe", Primitives.makeMessageConditionUnsafe, 1, false))),
