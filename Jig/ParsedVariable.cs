...
public class ParsedVariable : Expression {
    ...
    public ParsedVariable(Identifier id, Expansion.Parameter parameter, SrcLoc? srcLoc) : base (id.Symbol, srcLoc) {
        Parameter = parameter;
        Identifier = id;
    }

    public class TopLevel : ParsedVariable {
        public TopLevel(Identifier id, Expansion.Parameter parameter, SrcLoc? srcLoc) : base (id, parameter, srcLoc) {}
    }

    public class Lexical : ParsedVariable {
        public Lexical(Identifier id, Expansion.Parameter parameter, SrcLoc? srcLoc) : base(id, parameter, srcLoc) {
        }
