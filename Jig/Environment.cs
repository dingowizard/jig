...
public class Environment : IEnvironment {
    ...
    public Environment() {
        ...
        _dict.Add(new Form.Symbol("integer?"), new Procedure((Builtin) Number.integer_p));
        _dict.Add(new Form.Symbol("real?"), new Procedure((Builtin) Number.real_p));
        ...
        _dict.Add(new Form.Symbol("*"), new Procedure((Builtin) Number.product));
        _dict.Add(new Form.Symbol("/"), new Procedure((PairFunction) Number.divide));
        _dict.Add(new Form.Symbol("-"), new Procedure((PairFunction) Number.diff));
        _dict.Add(new Form.Symbol(">"), new Procedure( (Builtin)Number.gt));
        _dict.Add(new Form.Symbol(">="), new Procedure( (Builtin)Number.gte));
        _dict.Add(new Form.Symbol("<"), new Procedure( (Builtin)Number.lt));
        _dict.Add(new Form.Symbol("<="), new Procedure( (Builtin)Number.lte));
        _dict.Add(new Form.Symbol("mod"), new Procedure( (Builtin)Number.mod));
        ...
        _dict.Add(new Form.Symbol("string?"), new Procedure( (Builtin)String.string_p));
        _dict.Add(new Form.Symbol("boolean?"), new Procedure( (Builtin)Bool.boolean_p));
        _dict.Add(new Form.Symbol("boolean=?"), new Procedure( (ImproperListFunction2)Bool.boolean_eq_p));
